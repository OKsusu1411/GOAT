...
class Runner:
    def __init__(self, env: Wrapper, cfg: dict[str, Any]) -> None:
        """Experiment runner.
    ...
    def _generate_models(self, env: Wrapper, cfg: dict[str, Any]) -> dict[str, dict[str, Model]]:
    ...
    def _generate_trainer(self, env: Wrapper, cfg: dict[str, Any], agent: Agent) -> Trainer:
