...
bool imu_interface__msg__imu_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_interface.msg._imu_state.ImuState", full_classname_dest, 37) == 0);
  }
  imu_interface__msg__ImuState * ros_message = _ros_message;
  {  // header
  ...
  {  // time_ms
    ...
    ros_message->time_ms = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * imu_interface__msg__imu_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_interface.msg._imu_state");
