...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'assets', 'WF_GOAT', 'urdf'), glob('../../../lib/assets/GOAT/WF_GOAT/urdf/*.urdf')),
        # (os.path.join('share', package_name, 'assets', 'PF_GOAT', 'urdf'), glob('../../../lib/assets/TRON/PF_TRON1A/urdf/*.urdf')),
