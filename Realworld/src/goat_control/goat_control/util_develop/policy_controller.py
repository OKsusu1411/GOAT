...
class PolicyController(BaseController):
    ...
    def set_targets(self, 
        ...
        Args:
            ...
            base_quat:     Base quaternion        [rad], shape (3,).
            joint_pos:     Joint angle            [rad], shape (J,).
            joint_vel:     Joint velocity         [rad/s], shape (J,).
        """
        # Observation setting
        observation = np.hstack([base_ang_vel, base_quat, joint_pos, joint_vel]).reshape(1, -1) # [1, N]
