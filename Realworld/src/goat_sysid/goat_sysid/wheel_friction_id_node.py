...
class WheelFrictionIdNode(Node):
    ...
    def __init__(self) -> None:
        ...
        # plateau profile
        self.declare_parameter("speed_levels_rad_s", [1.0, 2.0, 4.0, 6.0])
        ...
        self.declare_parameter("J_known", 0.0)
        self.declare_parameter("v_min_rad_s", 0.5)
        self.declare_parameter("qdd_max_rad_s2", 0.5)  # used for fric_only steady-state selection
